          ...
          <div className="lg:grid lg:grid-cols-2 lg:gap-8 items-center">
            <div>
              ...
              <p className="text-lg text-gray-600">
                Мы гордимся тем, что 80% нашего производства расположено в России, что позволяет нам контролировать качество на всех этапах и поддерживать отечественную легкую промышленность.
              </p>
            </div>
